...
<html lang="en">
  <head>
    <meta charset="UTF-8">
    <title>Scouts Centinelas 113 | Registrar Usuario</title>
                ...
                <div class="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-secondary min-vh-100">
                  <a href="#" class="d-flex align-items-center pb-3 mb-md-0 me-md-auto text-secondary text-decoration-none">
                    ...
                    <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start mt-5" id="menu">
                        ...
                        <li class="mt-2">
                            <a href="gestionPersonal.php" class="nav-link text-white text-center align-middle px-0 fs-5 fw-bold rounded-pill" style="background-color: #c50d0d; width: 12rem;">Personal</span></a>
                        </li>
                        <li class="mt-2">
            ...
            <div class="col py-3" >
                <div class="mt-5">  <!-- tratar con este contener -->
                    <div class="container">
                        <div class="row">
                            <div class="col">
                                <h1 class="fw-bold mb-5" style="color:#c50d0d;">Crear Usuario</h1>
                                <?php 
                                ...
                                ?>
                                <form class="mt-4" method="post" action="../../Controller/registro/registrarUsuario.controller.php">
                                    <div class="row g-3 mb-6">
                                        <div class="col-6">
                                            <label for="Correo" class="form-label mb-2 fw-bold">Numero de Identidad *</label>
                                            <input type="text" name="NoIdentidad" class="form-control" placeholder="Numero de Identidad" aria-label="NumeroIdentidad" required>
                                        </div>
                                        <div class="col-6">
                                        ...
                                        <div class="col-6">
                                            <label for="Correo" class="form-label mb-2 fw-bold">Contraseña *</label>
                                            <input type="password" name="contraseña" class="form-control" placeholder="Contraseña" aria-label="Contraseña" required>
                                        </div>
                                        <div class="col-6">
                                            <label for="Correo" class="form-label mb-2 fw-bold">Correo Electronico *</label>
                                            <input type="email" name="correo" class="form-control" placeholder="Correo Electronico" aria-label="Ocupacion" required>
                                        </div>
                                        <div class="col-6">
                                            <label for="Correo" class="form-label mb-2 fw-bold">Rol *</label>
                                            <select name="Rol" id="Parentesco" class="form-select" required>
                                                <option value=""disabled selected>Seleccione el Rol del usuario</option>
                                                <option value="2">Jefe de grupo</option>
                                                <option value="3">Jefe de rama</option>
                                                <option value="5">Tesorero</option>
                                            </select>
                                        </div>
                                    </div>
                                    
                                    <button type="submit" name="registrarUsuario" class="btn fw-bold text-light text-center mt-5 mb-3" style="background-color: #c50d0d;">Crear Usuario</button>
                    
                                </form>
                                <a href="gestionPersonal.php" class="btn btn-success text-light fw-bold">Volver</a>
                            </div>
                        </div>
                    </div>
                </div>
