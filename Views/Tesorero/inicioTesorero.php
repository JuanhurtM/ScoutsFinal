                ...
                <div class="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-secondary min-vh-100">
                  <a href="#" class="d-flex align-items-center pb-3 mb-md-0 me-md-auto text-secondary text-decoration-none">
                    ...
                    <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start mt-5" id="menu">
                        ...
                        <li class="mt-2">
                            <a href="pagosTesorero.php" class="nav-link px-0 align-middle fs-5 fw-bold " style="color: #c50d0d;">Consultar pagos</span></a>
                        </li>
                    </ul>
                  <hr>
                  <div class="pb-4">
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <div class="container text-center mt-5">
                                    <div class="row">
                                        <div class="col">
                                            <a href="registroPagosTesorero.php" class="w-75 btn fw-bold fs-5 text-light text-center mt-5 mb-5" style="background-color: #c50d0d;">Nuevo pago</a>
                                        </div>
                                        <div class="col">
                                            <a href="pagosTesorero.php" class="w-75 btn fw-bold fs-5 text-light text-center mt-5 mb-5" style="background-color: #c50d0d;">Consultar pagos</a>
                                        </div>
                                    </div>
                                </div>   
                            </div>
