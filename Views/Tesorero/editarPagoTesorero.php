                ...
                <div class="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-secondary min-vh-100">
                  <a href="#" class="d-flex align-items-center pb-3 mb-md-0 me-md-auto text-secondary text-decoration-none">
                    ...
                    <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start mt-5" id="menu">
                        <li class="mt-2">
                            <a href="registroPagosTesorero.php" class="nav-link align-middle px-0 fs-5 fw-bold" style="color: #c50d0d;" >Nuevo pago</a>
                        </li>
                        <li class="mt-2">
                            <a href="pagos.php" class="nav-link text-white text-center align-middle px-0 fs-5 fw-bold rounded-pill" style="background-color: #c50d0d; width: 12rem;">Consultar pagos</span></a>
                        </li>
                    </ul>
                  <hr>
                  <div class="pb-4">
            ...
            <div class="col py-3" >
                <div class="mt-5">  <!-- tratar con este contener -->
                    <div class="container">
                        <div class="row">
                            <div class="col">
                                <h1 class="fw-bold mb-5" style="color:#c50d0d;">Editar pago</h1>
                                <?php
                                ...
                                ?>
                                <form class="mt-4" method="post" action="../../Controller/editar/editarPago.controllerTesorero.php">
                                    <div class="row g-3 mb-6">
                                        <div class="col-6">
                                            <label for="Correo" class="form-label mb-2 fw-bold">Numero del recibo *</label>
                                            <input type="text" value="<?php echo $NoRecibo2; ?>" name="NoRecibo" class="form-control" placeholder="Numero del recibo" aria-label="NumeroIdentidad" required>
                                        </div>
                                        <div class="col-6">
                                            <label for="FechaNacimiento" class="form-label mb-2 fw-bold">Fecha del recibo *</label>
                                            <input type="date" required value="<?php echo $Fecha; ?>" name="Fecha" class="form-control" placeholder="Fecha del recibo" aria-label="FechaNacimiento">
                                        </div>
                                        <div class="col-6">
                                            <label for="Nombre" class="form-label mb-2 fw-bold">Nombre Completo *</label>
                                            <input type="text" name="nombre" value="<?php echo $nombre; ?>" class="form-control" placeholder="Nombre Completo" aria-label="Nombre" required>
                                        </div>
                                        <div class="col-6">
                                            <label for="Correo" class="form-label mb-2 fw-bold">Concepto *</label>
                                            <input type="text" name="concepto" value="<?php echo $concepto; ?>" class="form-control" placeholder="Concepto" aria-label="Contraseña" required>
                                        </div>
                                        <div class="col-6">
                                            <label for="Correo" class="form-label mb-2 fw-bold">Valor *</label>
                                            <input type="text" name="valor" value="<?php echo $valor; ?>" class="form-control" placeholder="Valor del recibo" aria-label="Ocupacion" required>
                                        </div>
                                        <div class="col-6">
                                            <label for="Correo" class="form-label mb-2 fw-bold">Scout asociado</label>
                                            <input type="text" name="scout" value="<?php echo $NoIdScout; ?>" class="form-control" placeholder="Numero de identidad del scout" aria-label="Ocupacion">
                                        </div>
                                    </div>
                                    
                                    <button type="submit" name="updatePago" class="btn fw-bold text-light text-center mt-5 mb-3" style="background-color: #c50d0d;">Guardar</button>
                                ...
                                <a href="pagosTesorero.php" class="btn btn-success text-light fw-bold">Volver</a>
                            </div>
                        </div>
                    </div>
                </div>
