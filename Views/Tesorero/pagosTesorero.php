                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col">
                                ...
                                ?>
                                <a href="registroPagosTesorero.php" class="btn btn-success text-light fw-bold mt-4 mb-4">Registrar nuevo Pagos</a>
                                <table class="table table-hover table-bordered mt-4 display shadow-lg">
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="editarPagoTesorero.php?id=<?php echo $NoRecibo?>" class="btn btn-secondary fw-bold rounded-pill"><img src="../../Assets/Img/pencil-fill.svg"></a>
                                                <a href="../../Controller/consultas/eliminarPago.controllerTesorero.php?id=<?php echo $NoRecibo?>" class="btn text-light fw-bold rounded-pill" style="background-color: #c50d0d;"><img class="text-light" src="../../Assets/Img/trash-fill.svg"></a>
                                            </td>
                                        </tr>
                                    <?php
                                ...
                                <a href="inicioTesorero.php" class=" btn fw-bold  text-light text-center mt-4" style="background-color: #c50d0d;">Volver</a>
                            </div>
                        </div>
                    </div>
                </div>
