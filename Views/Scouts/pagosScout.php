                ...
                <div class="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-secondary min-vh-100">
                  <a href="#" class="d-flex align-items-center pb-3 mb-md-0 me-md-auto text-secondary text-decoration-none">
                    ...
                    <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start mt-5" id="menu">
                        ...
                        <li class="mt-2">
                            <a href="pagosScout.php?id=<?php echo $id;?>" class="nav-link text-white text-center align-middle px-0 fs-5 fw-bold rounded-pill" style="background-color: #c50d0d; width: 12rem;">Visualizar pagos</span></a>
                        </li>
                    </ul>
                  <hr>
                  <div class="pb-4">
                            ...
                            <div class="col">
                                ...
                                <table class="table table-hover table-bordered mt-4 display shadow-lg">
                                    ...
                                    <?php 
                                        ...
                                        $sql = "SELECT * FROM pagos WHERE NoIdScout = '$id'";
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="detallePago.php?id=<?php echo $NoRecibo?>" class="btn btn-secondary fw-bold rounded-pill">Ver pago <img src="../../Assets/Img/eye-fill.svg"></a>
                                            </td>
                                        </tr>
                                    <?php
                                ...
                                <a href="inicioScouts.php" class=" btn fw-bold  text-light text-center mt-4" style="background-color: #c50d0d;">Volver</a>
                            </div>
                        </div>
                    </div>
                </div>
